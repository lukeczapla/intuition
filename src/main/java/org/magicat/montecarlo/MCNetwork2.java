package org.magicat.montecarlo;
...
public class MCNetwork2 extends MCNetwork {
    private static Logger log = LoggerFactory.getLogger(MCNetwork2.class);

    public MCNetwork2(int seed) {
        super();
        configuration = new NeuralNetConfiguration.Builder()
                ...
                //         .updater(new Sgd(0.2))
                .dropOut(0.5)
                .updater(new Nesterovs(0.01, 0.8))
                //.l2(1e-4)
                .list()
