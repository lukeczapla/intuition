...
public final class ExamplesData {
    ...
    static final String[][] DOCUMENTS_DATA_MINING = {
            ...
            // fragment-end{search-results-array}
            {
                    ...
                    "A collection of Data Mining links "
                            + "edited by the Central Connecticut State University ... Graduate "
                            + "Certificate Program. Data Mining "
            ...
            },
            {
                    ...
                    "Newsletter on "
                            + "the data mining and knowledge industries, offering information on data mining, "
                            + "knowledge discovery, text"
                            + " mining, and web mining software, courses, jobs, publications, and "
                            + "meetings."
            },
            {
                    ...
                    "Data mining - Wikipedia, the free encyclopedia",
                    "Data mining "
                            + "is considered a subfield within the Computer Science field of knowledge discovery. ... "
                            + "claim to perform "
            ...
            },
            {
                    ...
                    "Provides information about data mining "
                            + "also known as knowledge discovery in databases (KDD) or "
                            + "simply knowledge discovery. List software, "
                            + "events, organizations, and people working in data "
                            + "mining."
            },
            {
                    ...
                    "... complete data mining customer ... Data mining applications, on the other hand, embed ."
                            + "."
                            + ". it,"
                            + " our daily lives are influenced by data mining applications. ..."
            },
            {
                    "http://datamining.typepad.com/data_mining/",
                    "Data Mining: Text Mining, Visualization and Social Media",
                    "Commentary on text mining, data mining, social media and data visualization. ... Opinion Mining "
                            + "Startups"
            ...
            },
            {
                    ...
                    "Outlines the crucial concepts "
                            + "in data mining, defines the data warehousing process, and offers "
                            + "examples of computational and graphical"
                            + " exploratory data analysis techniques."
            },
            {
                    "http://answers.yahoo.com/question/index?qid=1006040419333",
                    "<b>answers.yahoo.com</b>/question/index?qid" + "=1006040419333",
                    "Generally, data mining (sometimes "
                            + "called data or knowledge discovery) is the ... "
                            + "Midwest grocery"
                            + " chain used the data mining capacity "
                            + "of Oracle software to ..."
            },
            {
                    "http://www.ccsu.edu/datamining/master.html",
                    "CCSU - Data Mining",
                    "Details on how to apply to the Master "
                            + "of Science in data mining may be found here. ... All data "
                            + "mining majors are classified for business "
            ...
            },
            {
                    ...
                    "Kurt Thearling's "
                            + "site dedicated to sharing information about data mining, the automated extraction "
                            + "of hidden "
                            + "predictive "
            ...
            },
            {
                    ...
                    "Data mining is the process of selecting, exploring "
                            + "and modeling large amounts of ... The "
                            + "knowledge gleaned from data and text mining can be used to "
                            + "fuel ..."
            },
            {
            ...
            },
            {
                    ...
                    "Oracle Data Mining",
                    "Oracle Data Mining "
                            + "Product Center ... Using data mining functionality embedded in Oracle Database "
                            + "10g, you can find ... "
            ...
            },
            {
                    ...
                    "Data Mining Project",
                    "A long term Knowledge Discovery and Data Mining project which has the current ... Read more about "
                            + "how data mining is "
            ...
            },
            {
                    ...
                    "... high performance networking, internet computing, "
                            + "data"
                            + " mining and related areas. ... Peter Stengard, Oracle Data Mining Technologies. prudsys AG, "
                            + "Chemnitz, .."
                            + "."
            },
            {
                    ...
                    "Commentary on text mining, data mining, social "
                            + "media and data visualization. ... Data Mining points "
                            + "to the latest papers from the 3rd International "
                            + "Workshop on ..."
            },
            {
                    ...
                    "Data "
                            + "mining is the analysis of "
                            + "data "
                            + "for relationships that have not previously been discovered. ... Data"
            ...
            },
            {
                    ...
                    "Data mining, the "
                            + "extraction of hidden predictive information from large ... prospective analyses "
                            + "offered by data "
                            + "mining "
            ...
            },
            {
                    ...
                    "Oracle Data Mining",
                    "Using data "
                            + "mining functionality embedded in ... Oracle Data Mining JDeveloper and SQL Developer ... "
                            + "Oracle "
            ...
            },
            {
                    ...
                    "A community about data mining. Tag "
                            + "and discover new products. ... Data Mining (Paperback) Data "
            ...
            },
            {
                    ...
                    "MIT "
                            + "OpenCourseWare | Sloan School of Management | 15.062 Data Mining, Spring 2003 | Home",
                    "... class "
                            + "of"
                            + " methods known as data mining that assists managers in recognizing ... Data mining "
                            + "is a rapidly "
                            + "growing "
            ...
            },
            {
                    ...
                    "Om Data Mining och Text Mining. Ta fram s\u00E4kra "
                            + "beslutsunderlag med Data Miningverktyg fr\u00E5n"
                            + " SAS Institute.",
                    "SAS Insitutes business "
                            + "intelligence "
                            + "ger v\u00E4rdefull kunskap till hela din"
                            + " ... Till\u00E4mpningen av data mining "
                            + "str\u00E4cker sig "
                            + "\u00F6ver m\u00E5nga branscher och "
                            + "omr\u00E5den. ..."
            },
            {
                    ...
                    "Data Mining and Knowledge Discovery - A peer-reviewed journal publishing ... "
                            + "In assessing the "
                            + "potential of data mining based marketing campaigns one needs to ..."
            },
            {
                    "http://www.investorhome.com/mining.htm",
                    "Investor Home - Data Mining",
                    "Data Mining or Data Snooping is "
                            + "the practice of searching for relationships and ... up by making a "
                            + "case study in data mining out of "
                            + "the "
            ...
            },
            {
                    ...
                    "Amazon.com: Data Mining: "
                            + "Concepts and Techniques (The Morgan Kaufmann Series in Data Management "
                            + "Systems): Jiawei Han...",
                    "Amazon"
                            + ".com: Data Mining: Concepts and Techniques (The Morgan Kaufmann "
            ...
            },
            {
                    ...
                    "Data "
                            + "Mining, la extracci\u00F3n de informaci\u00F3n oculta y predecible de grandes bases ... Las "
                            + "herramientas"
            ...
            },
            {
                    ...
                    "Data Mining Technology "
                            + "from Megaputer ... Typical tasks addressed by data mining include: ... Yet, "
                            + "data mining requires far "
            ...
            {"http://datamining.itsc.uah.edu/", "itsc data mining solutions center", ""},
            {
                    ...
                    "This article debunks several myths about data mining and presents a plan of "
                            + "action to avoid some of"
                            + " the pitfalls. ... a typical data mining conference or ..."
            },
            {
                    "http://research.microsoft.com/dmx/",
                    "Data Management, Exploration and Mining- Home",
                    "The Data Management "
                            + "Exploration and Mining Group (DMX) ... Our research effort in data mining focuses"
                            + " on ensuring that "
                            + "traditional ..."
            },
            {
                    ...
                    "."
                            + ".. a collection of links to publications on the subject of biomedical text mining. Data mining "
                            + "Open "
            ...
            },
            {
                    ...
                    "Data Mining",
                    "Data Mining Services provide customers with "
                            + "tools"
                            + " to quickly sift through the ... into Datapult Central for use with Data Mining tools and "
                            + "other Datapult"
                            + " products. ..."
            },
            {
                    ...
                    "SIAM International "
                            + "Conference on Data Mining, co-Sponsored by AHPCRC and ... Clustering High "
            ...
            },
            {
                    ...
                    "Learn about data mining and knowledge discovery, the process"
                            + " of finding patterns ... "
                            + "Cross "
            ...
            },
            {
                    ...
                    "... Sapphire-a semiautomated, flexible data-mining "
                            + "software infrastructure. ... Data mining is not "
                            + "a new field. ... scale, scientific data-mining "
                            + "efforts "
                            + "such ..."
            },
            {
                    ...
                    "SQL Server Data Mining Portal ... "
                            + "information about our exciting data mining features. ... CTP of "
            ...
            },
            {
                    ...
                    "As recently as two "
                            + "years ago, data mining was a new concept for many people. Data mining products "
                            + "were new and marred by "
            ...
            },
            {
                    ...
                    "Some example application areas are listed under"
                            + " Applications Of Data Mining ... Crows "
                            + "Introduction - \"Introduction to Data Mining and Knowledge "
                            + "Discovery\"- http: ..."
            },
            {
                    "http://www.pentaho.com/products/data_mining/",
                    "Pentaho Commercial Open Source Business Intelligence: Data " + "Mining",
                    "... (BI) to the next level by "
                            + "adding data mining and workflow to the mix. ... Pentaho Data "
                            + "Mining "
                            + "is differentiated by its "
                            + "open, standards-compliant nature, ..."
            },
            {
                    "http://www.unf.edu/~selfayou/html/data_mining.html",
                    "Data Mining",
                    "This course approaches data mining "
                            + "topics from an Artificial Intelligence ... The course will also "
                            + "cover Applications and Trends in Data"
                            + " "
                            + "Mining. Textbook: ..."
            },
            {
                    ...
                    "data mining software & predictive modeling sold online by statsoft.com. ... of automated and "
                            + "ready"
                            + "-to-deploy data mining solutions for a wide variety of ..."
            },
            {
                    "http://gosset.wharton.upenn.edu/wiki/index.php/Main_Page",
                    "Main Page - Knowledge Discovery",
                    "The Penn "
                            + "Data Mining Group develops principled means of modeling and ... knowledge of specific "
                            + "application "
                            + "areas "
            ...
            },
            {
                    ...
                    "Inductis "
                            + "offers high-level data mining services to assist management decisions ... The Data Mining "
                            + "Shootout .."
            ...
            },
            {
                    ...
                    "Microsoft"
                            + " SQL Server Data Mining helps you explore your business data and discover patterns to reveal"
                            + " the "
                            + "hidden "
            ...
            },
            {
                    ...
                    "Recognizing outstanding practical "
                            + "contributions in the field of data mining. ... case studies are one of the most discussed topics at "
                            + "data"
                            + " mining conferences. ..."
            },
            {
                    ...
                    "This page describes the term data mining and lists other pages on the "
                            + "Web where you can find "
                            + "additional information. ... Data Mining and Analytic Technologies ..."
            },
            {
            ...
            {"http://www.datamining.org/", "data mining institute", ""},
            {
                    ...
                    "Next "
                            + "Generation Data Mining Tools: Power laws and self-similarity for graphs, ... Parallel session "
                            + "4 - "
            ...
            },
            {
                    ...
                    "what is data mining?",
                    "... the "
                            + "purchases of customers, a data mining system could identify those customers ... A simple example of "
                            + "data"
            ...
            },
            {
                    ...
                    "The field of "
                            + "data mining draws upon extensive work in areas such as statistics, ... recent results "
                            + "in data mining, "
            ...
            },
            {
                    ...
                    "St@tServ Data Mining page ... "
                            + "Data mining in molecular biology, by Alvis Brazma. Graham Williams "
                            + "page. Knowledge Discovery and Data"
                            + " "
                            + "Mining Resources, ..."
            },
            {
                    ...
                    "Data Mining "
                            + "and Knowledge Discovery - Data Mining and Knowledge Discovery Journals, Books & Online "
                            + "Media | Springer",
                    "Technical journal focused on the theory, techniques, and practice for extracting"
                            + " information from "
                            + "large databases."
            },
            {
                    ...
                    "Data mining is "
                            + "frequently"
                            + " described as &quot;the process of extracting ... Creating a data mining model is a "
                            + "dynamic and "
                            + "iterative process. ..."
            },
            {
                    ...
                    "Data Mining Institute at UW-Madison ... The "
                            + "Data Mining Institute (DMI) was ... Corporation with "
                            + "the support of the Data Mining Group of "
                            + "Microsoft "
                            + "Research. ..."
            },
            {
                    ...
                    "... Website for Data Mining Methods "
                            + "and"
                            + " ... data mining at Central Connecticut State University, he ... also provides data mining "
                            + "consulting "
                            + "and statistical ..."
            },
            {
            ...
            },
            {
                    ...
                    "What is the current state of data mining? "
                            + "The immediate future ... Data Mining is the process of "
                            + "extracting knowledge hidden from large volumes of"
                            + " ..."
            },
            {
            ...
            },
            {
                    ...
                    "Find Data Mining downloads, "
                            + "reviews, and updates for Mac OS X including "
                            + "commercial "
                            + "software, shareware and freeware on "
                            + "VersionTracker.com."
            },
            {
            ...
            },
            {
                    ...
                    "Data Mining "
                            + "is the automated extraction of hidden predictive information from databases. ... The data"
                            + " mining tools"
                            + " "
                            + "can make this leap. ..."
            },
            ...
            },
            {
                    ...
                    "Chapter 4. Data Mining Primitives, Languages, and "
                            + "System Architectures ... Chapter 9. Mining "
                            + "Complex Types of Data ... to Microsoft's OLE DB for Data "
                            + "Mining ..."
            },
            {
                    ...
                    "Dedicated to the development, marketing, "
                            + "sales and support of tools for knowledge discovery to make"
                            + " data mining accessible and easy to use."
            },
            {
                    "http://www.autonlab.org/tutorials",
                    "Statistical Data Mining Tutorials",
                    "Includes a set of tutorials on "
                            + "many aspects of statistical data mining, including the foundations "
                            + "of probability, the foundations of"
                            + " "
                            + "statistical data analysis, and most of the classic machine "
            ...
            },
            {
                    ...
                    "\"Web "
                            + "usage mining: discovery and applications of web usage patterns from web data\" ... Patterns "
                            + "and Trends "
            ...
            },
            {
                    ...
                    "Apa yang bisa dan tidak bisa dilakukan data mining ? ."
                            + "."
                            + ". Iko Pramudiono \"&raquo ... Apa itu "
                            + "data mining ? Iko Pramudiono \"&raquo. artikel lainnya \" "
                            + "tutorial"
                            + " ..."
            },
            {
                    ...
                    "Affymetrix is dedicated to developing state-of-the-art technology "
                            + "for acquiring, analyzing, and "
                            + "managing complex genetic ... The Data Mining Tool (DMT) ..."
            },
            {
            ...
            },
            {
                    ...
                    "Text Mining for Clementine from"
                            + " SPSS enables you to use text data to improve the "
                            + "accuracy"
                            + " of predictive models. ... and about data"
                            + " mining in general. ..."
            },
            {
                    ...
                    "Without data mining, a "
                            + "merchant isn't even close to leveraging what customers want and will buy. ... "
                            + "Data mining is to be "
                            + "found"
            ...
            },
            {
                    ...
                    "Going"
                            + " Beyond the Numbers: Context-Sensitive Data Mining ... Data mining examples ... many websites "
                            + "employing "
            ...
            },
            {
                    ...
                    "... "
                            + "Walmart, Fundraising Data Mining, Data "
                            + "Mining"
                            + " Activities, Web-based Data Mining, ... in many "
                            + "industries makes us the best choice for "
                            + "your data mining"
                            + " needs. ..."
            },
            {
                    ...
                    "Shop for Data Mining V: Data"
                            + " Mining, Text "
                            + "Mining"
                            + " and Their Business Applications : Fifth International Conference on Data "
                            + "Mining "
            ...
            },
            {
                    ...
                    "Data Mining es la tecnolog\u00EDa BI que le ayudar\u00E1 a construir modelos anal\u00EDticos complejos "
                            + "e"
            ...
            },
            {
                    ...
                    "Although data "
                            + "mining by itself is not going to get the Celtics to the playoffs, ... then, firms that "
                            + "specialize in "
            ...
            },
            {
                    ...
                    "... are excellent candidates for data "
                            + "mining, fault prediction, problem diagnosis, ... Data Mining "
                            + "uses this theory to support Link and "
            ...
            },
            {
                    ...
                    "Verification-Driven Data Mining. "
                            + "Advantages of Symbolic Classifiers. Manual vs. Automatic ... "
                            + "Currently, data mining solutions have "
                            + "been "
            ...
            },
            {
                    ...
                    "data"
                            + " mining, civil liberties, civil rights, terrorism, september 11th, anti-terrorism, ashcroft, "
                            + "government "
            ...
            },
            {
                    ...
                    "... conducting research in various areas in data "
                            + "mining and other related fields. ... on Data "
    ...
    public static Stream<Document> documentStream() {
        return Arrays.stream(ExamplesData.DOCUMENTS_DATA_MINING)
                .map(
                        fields ->
                                (fieldVisitor) -> {
